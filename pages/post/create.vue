          ...
          <div class="main">
            ...
            <p> 分享你的个人游记，让更多人看到哦！</p>
              ...
              <el-form-item prop="title">
                  <el-input v-model="form.title" placeholder="请输入标题"  @focus="clearRules('title')"></el-input>
              </el-form-item>
              ...
              <el-form-item label="选择城市"  prop="city">
                ...
                ></el-autocomplete>
                  ...
                  <el-form-item >
                       <el-button type="primary" size="small" @click="submint">发布</el-button>
  ...
  <el-col :span="6">
      <div class="aside">
          <el-row>
           ...
           <el-row v-for="(value,index) in $store.state.post.posts" :key="index" >
                <div class="aside-content" >
                    <div class="content-title">{{value.title}}</div>
                </div>
                <div class="content-footer">
                  <span class="content-data">{{new Date().getFullYear()}}-{{new Date().getMonth()+1}}-{{new Date().getDate()}}</span>
