      ...
      <div class="hotelList" v-if="hotelList && hotelList.length > 0">
       <el-row  class="hotelList-row"  v-for="(v,i) in hotelList" :key="i">
        ...
        <el-col :span="10" >
          ...
          <div class="hotel-en-name">{{v.alias}}
           <span v-if="v.hotellevel">
              <i class="iconfont iconhuangguan"
          v-for="(value,index) in v.hotellevel.level" :key="index" 
          ...
          <div class="rate">
            ...
            <el-rate
             ...
             <el-col :span="7"><span style="color: orange;" >{{v.common_remarks}}</span> 篇游记</el-col>
          </div>
          ...
          <ul class="price-col" v-if="v.products">
            <li v-for="(value,index) in v.products" :key="index">
              ...
              <div class="price-col-right">
                <span style="color: orange;">￥{{value.price}}</span> 起<i class="el-icon-arrow-right" style="margin-left:5px"></i></div>
            </li>
          </ul>
        </el-col>
       </el-row>
